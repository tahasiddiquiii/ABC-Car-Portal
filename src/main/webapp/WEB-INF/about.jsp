...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="revolution/css/layers.css">
  <link rel="stylesheet" type="text/css" href="revolution/css/navigation.css">  -->
  <link rel="stylesheet" href="res/res/plugins/tf-fonts.min.css">
  <!-- bootstrap.min css -->
...
<section class="about" id="about">
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 " >
	               <div class="team-member text-center">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-responsive" src="res/images/team/member-1.jpg" alt="Meghna">
							<!-- /member photo -->
				...
				<div class="col-md-4 col-sm-6 " >
	               <div class="team-member text-center">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-responsive" src="res/images/team/member-2.jpg" alt="Meghna">
							<!-- /member photo -->
				...
				<div class="col-md-4 col-sm-6 ">
	               <div class="team-member text-center">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-responsive" src="res/images/team/member-3.jpg" alt="Meghna">
							<!-- /member photo -->
	...
	<section class="promo-video section bg-gray">
	<div class="container">
		<div class="row">
			<!-- section title -->
				<div class="title text-center" >

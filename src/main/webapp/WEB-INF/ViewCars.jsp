  ...
  <br>
	...
	<div class="container mt-5">
		...
		<Table border=1 style="text-align:center; margin:4px;" class="table table-bordered table-hover">
			...
			<th scope="col" style="text-align:center;">Price <span class="text-muted">(In Rupees)</span></th>
			...
			<tr>		
				...
				<td>
					<form action="/user/buy/${cars.id }">
						<button class="btn btn-primary" onclick="buycar()" style="background-color:#FFA500"  >Buy this Car</button>
					</form>					
				</td>
			</tr>

...
<title> error login | ABC Cars</title>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <h2 class="text-center">User Deleted Successfully!</h2>
         
		
		<img src="/resources/Images/deleteAcc.jpeg" alt="image" width="300px">
		<a href="/admin/viewallmembers" class="btn btn-main text-center" ><h5><center> see all member</center></h5></a>

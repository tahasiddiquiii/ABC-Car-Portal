    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-left">
          ...
          <h2 class="text-center">Post Car Details You want to sell</h2>
          ...
          <sf:form action="/admin/postCarDetails" method="post" modelAttribute="postCarDetails">
            ...
            <label for="distance">Manufacturing Year</label>
					<sf:input path="year" name="year" class="form-control" placeholder="Manufacturing Year"/>
            ...
            <label for="distance">Price</label>
             ...
             <label for="image">Car Image</label>
					<sf:input path="image" name="image" type="file" class="form-control" placeholder="Car Image"/>
